!++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
! .COPYRIGHT	(C) MPIA
! .IDENT	dither_point_single.prg
!
! .CALL		@@ dither_point_single icatalog itime=[tot_pointing,tot_single,single]
...
!                       20.01.10        Version for individually saved frames (U.T.)
!
!+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
write/out
write/out
write/out "*** Program version to save INDIVIDUAL frames! ***"
write/out
