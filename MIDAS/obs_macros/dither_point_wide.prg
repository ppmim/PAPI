!++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
! .COPYRIGHT	(C) MPIA
! .IDENT	dither_point_small.prg
!
! .CALL		@@ dither_point_small icatalog itime=[tot_pointing,tot_single,single]
...
!		with OMEGA2000. The offsets are wider than in the 
!               programme dither_pointing.prg  (max. radius = 130")
! .ENVIRONMENT	MIDAS
! .AUTHOR	Rene Fassbender    (modified 06.04.2009, U. Thiele) 
...
write/out
write/out "dither_point_small.prg"
write/out "call: @@ dither_point_small icatalog itime=[tot_pointing,tot_single,single]"
write/out "			       start_pos pointing	"
write/out
write/out "This program takes dithered images for one pointing for OMEGA2000:"
write/out "The area with no overlap is maximally 13 arcsec on each side"
write/out 
...
!  write/keyword x_offset/i/11/10 -209,150,-90,317,-42,-216,143,-237,36,254
   ...
   write/keyword x_offset/i/1/10 0,500,-750,900,-1130,-240,990,630,-1740,990
   write/keyword x_offset/i/11/10 -1040,750,-450,1450,-70,-1080,710,-1190,180,1260
...
!  write/keyword y_offset/i/11/10 -74,-309,162,-98,291,-99,-56,-192,360,-395
   ...
   write/keyword y_offset/i/1/10 0,500,280,-1080,-140,750,-990,910,-440,1080
   write/keyword y_offset/i/11/10 -190,-1590,850,-480,1450,-500,-270,-960,1620,-1610
 
  
  define/local X_back/I/1/1 -670
  define/local Y_back/i/1/1 810
...
!  write/keyword x_offset/i/11/10 -207,153,-90,315,-45,-216,144,-234,36,252
   ...
   write/keyword x_offset/i/1/10 0,450,-720,900,-1170,-270,990,630,-1710,990
   write/keyword x_offset/i/11/10 -1080,720,-450,1440,-90,-1080,720,-1170,180,1260
...
!  write/keyword y_offset/i/11/10 -72,-306,162,-99,288,-99,-54,-189,360,-396
   ...
   write/keyword y_offset/i/1/10 0,450,270,-1080,-180,720,-990,900,-450,1080
   write/keyword y_offset/i/11/10 -180,-1620,810,-450,1440,-450,-270,-990,1620,-1620

  define/local X_back/I/1/1 -540
  define/local Y_back/i/1/1 990
...
define/local x_repetition/i/1/20 0,-27,36,9,-45,9,27,-36,36,-27
write/keyword x_repetition/i/11/10 9,27,-9,-27,36,-27,36,-45,45,-27

define/local y_repetition/i/1/20 27,18,-45,45,-36,36,-27,18,9,-36
write/keyword y_repetition/i/11/10 27,-36,36,-36,18,27,-27,9,18,-45
