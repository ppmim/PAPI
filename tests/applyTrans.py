...
def applyTransformation(src_path, dst_path, rot=0, xc=0, yc=0, scale=1, shear=0 ):
    """ Apply an Affine transformation to an image (a rotation, a translation, a scale, or a shear) using Homogrphy matrix H"""
    ...
    cos_r=math.cos(2*np.pi*rot/360) 
    sin_r=math.sin(2*np.pi*rot/360)
