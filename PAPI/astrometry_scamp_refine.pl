#!/usr/bin/perl -w
#
# run this script after astrometry_scamp.pl. this script uses the first pass 
# WCS parameters to run WCSTools again with a smaller clipping radius.
#
# March 2001
# Mai 2003: debug. add 2mass option
# Sep 2009: adaption to PANIC


die "Usage: astrometry_scamp_refine.pl apm|usno|2mass *.fits\n" 
    unless ($#ARGV >= 1);
...
sub decdeg; # defined in astrometry_scamp.pl
