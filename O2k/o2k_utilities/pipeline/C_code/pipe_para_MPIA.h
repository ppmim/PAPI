...
#define SKY_FRAMES_MAX 7  	/* maximun allowed number of frames before and after */
				/* main frame used for sky */
				/* # of stack levels = 2*SKY_FRAMES_MAX + 1 */


/* Parameters for SUMMATION PROCESS */
#define N_AVERAGE_MAX 11     	/* maximum allowed number of total frames for median process*/
...
#define DEBUG 3			/* 0=only normal output ; 1=additional output from OMEGA_pipe */
