...
define/parameter P4 7,1,0 N		! sum
define/parameter P5 5 N 		! kappa_sum
...
define/parameter P8 noinput C		! calibration frames
	!! has to be modified that flat for right filter is selected
...
!++++++++++++++ 3 PIPELINE SETUP +++++++++++++++++++++++++++++++++++++++++++++++++++++++
	...
	! absolute path were online information fliles are stored
	! define keyword which contains the path where all relevant files are
define/local file_path/c/1/60 "/disk-v/fassbend/pipeline"
...
define/local flag_key/I/1/3 {P7} ? +lower_levels
	...
	! Calibration frames with defaults
