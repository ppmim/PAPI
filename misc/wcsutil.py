...
Modification History:
    ...
    2013-06-17: If CUNITS is missing in header, 'deg' is supposed !
    2013-06-18: If no dist_coeffs are found, then self.distort = None (ExtractDistortionModel) 
    ...
    def ExtractDistortionModel(self):
        if self.projection not in _allowed_projections:
            ...
            if ca != 0:
                ...
                # No distortion coeffs found;   jmiguel@iaa.es 18-Jun-2013
                self.distort = None 
